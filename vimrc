...
" Toggle
nnoremap <LocalLeader>n :<C-U>setlocal number! number?<CR>
nnoremap <LocalLeader>N :<C-U>setlocal relativenumber! relativenumber?<CR>
nnoremap <LocalLeader>l :<C-U>setlocal list! list?<CR>
nnoremap <LocalLeader>s :<C-U>setlocal scrollbind! scrollbind?<CR>
